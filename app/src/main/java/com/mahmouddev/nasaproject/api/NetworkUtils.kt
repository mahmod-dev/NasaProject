package com.mahmouddev.nasaproject.api


import com.mahmouddev.nasaproject.Constants
import com.mahmouddev.nasaproject.Constants.API_QUERY_DATE_FORMAT
    ...
    for (formattedDate in nextSevenDaysFormattedDates) {
        ...
        for (i in 0 until dateAsteroidJsonArray.length()) {
            ...
            val asteroid = Asteroid(
                id.toInt(), codename, formattedDate, absoluteMagnitude,
